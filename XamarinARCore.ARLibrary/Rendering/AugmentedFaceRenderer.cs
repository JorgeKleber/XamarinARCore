...
namespace XamarinARCore.ARLibrary.Rendering
{
    public class AugmentedFaceRenderer
    {
        ...
        private static string VERTEX_SHADER_NAME = "shaders/object.vert";
        private static string FRAGMENT_SHADER_NAME = "shaders/object.frag";
        private int program;
        ...
        public void draw(float[] projmtx, float[] viewmtx, float[] modelmtx, float[] colorCorrectionRgba, AugmentedFace face)
        {
            ...
            Android.Opengl.Matrix.MultiplyMM(modelViewProjectionMatTemp, 0, projmtx, 0, viewmtx, 0);
            Android.Opengl.Matrix.MultiplyMM(modelViewProjectionMat, 0, modelViewProjectionMatTemp, 0, modelmtx, 0);
            Android.Opengl.Matrix.MultiplyMM(modelViewMat, 0, viewmtx, 0, modelmtx, 0);

            // Set the lighting environment properties.
            Android.Opengl.Matrix.MultiplyMV(viewLightDirection, 0, modelViewMat, 0, lightDirection, 0);

            normalizeVec3(viewLightDirection);

            GLES20.GlUniform4f(lightingParametersUniform, viewLightDirection[0], viewLightDirection[1], viewLightDirection[2], 1);
            ...
            GLES20.GlDrawElements(GLES20.GlTriangles, triangleIndices.Limit(), GLES20.GlUnsignedShort, triangleIndices);
