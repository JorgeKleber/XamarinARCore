...
namespace XamarinARCore.ARLibrary.Rendering
{
    public class ObjectRenderer
    {
        ...
        public void CreateOnGlThread(Context context, string objAssetName, string diffuseTextureAssetName)
        {
            ...
            GLES20.GlBufferSubData(GLES20.GlArrayBuffer, normalsBaseAddress, 4 * (normals?.Limit() ?? 1), normals);
        ...
        private void CompileAndLoadShaderProgram(Context context)
        {
            ...
            var vertexShader = ShaderUtil.LoadGLShader(context, GLES20.GlVertexShader, VERTEX_SHADER_NAME);
            var fragmentShader = ShaderUtil.LoadGLShader(context, GLES20.GlFragmentShader, FRAGMENT_SHADER_NAME, defineValuesMap);
